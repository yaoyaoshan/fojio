...
import com.example.jpastudent.mapper.StudentMapper;
...
public class StudentService {
    ...
    public List<Student> getStudentsContainStrInName(String strInName) {
        return studentMapper.getStudentsContainStrInName("%" + strInName + "%");
    }
}
